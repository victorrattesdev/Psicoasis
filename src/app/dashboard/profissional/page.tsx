  ...
  const patients = [
    {
      ...
      status: "Ativo",
      progress: "Bom progresso"
    },
    {
      id: 2,
      name: "João Silva",
      lastAppointment: "2024-10-14",
      nextAppointment: "2024-10-21",
      status: "Ativo",
      progress: "Melhorando"
    },
    {
        ...
        <div className="bg-white rounded-lg p-6 shadow-sm border">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-bold text-gray-900">{counts?.todayCount ?? 0}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg p-6 shadow-sm border">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-bold text-gray-900">{counts?.patientsCount ?? 0}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg p-6 shadow-sm border">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-bold text-gray-900">R$ {counts?.monthlyRevenue ?? 0}</p>
            </div>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-white rounded-lg p-6 shadow-sm border">
          ...
          <div className="space-y-3">
            <button className="flex items-center p-3 bg-indigo-50 rounded-lg hover:bg-indigo-100 transition-colors w-full">
              <svg className="w-5 h-5 text-indigo-600 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6v6m0 0v6m0-6h6m-6 0H6" />
              </svg>
              <span className="text-indigo-700 font-medium">Nova Consulta</span>
            </button>
            <button className="flex items-center p-3 bg-green-50 rounded-lg hover:bg-green-100 transition-colors w-full">
              ...
              <span className="text-green-700 font-medium">Relatório de Sessão</span>
            </button>
            <button className="flex items-center p-3 bg-purple-50 rounded-lg hover:bg-purple-100 transition-colors w-full">
              ...
              <span className="text-purple-700 font-medium">Gerenciar Pacientes</span>
            </button>
          </div>
        </div>

        <div className="bg-white rounded-lg p-6 shadow-sm border">
          <h3 className="text-lg font-semibold text-gray-900 mb-4">Ferramentas</h3>
          <div className="space-y-3">
            <button className="flex items-center p-3 bg-blue-50 rounded-lg hover:bg-blue-100 transition-colors w-full">
              ...
              <span className="text-blue-700 font-medium">Relatórios e Estatísticas</span>
            </button>
            <button className="flex items-center p-3 bg-yellow-50 rounded-lg hover:bg-yellow-100 transition-colors w-full">
              ...
              <span className="text-yellow-700 font-medium">Agenda e Disponibilidade</span>
            </button>
            <button className="flex items-center p-3 bg-red-50 rounded-lg hover:bg-red-100 transition-colors w-full">
              <svg className="w-5 h-5 text-red-600 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1" />
              </svg>
              <span className="text-red-700 font-medium">Financeiro</span>
            </button>
          </div>
        </div>
      </div>
              ...
              <div key={patient.id} className="flex items-center justify-between p-4 border border-gray-200 rounded-lg">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Última consulta: {new Date(patient.lastAppointment).toLocaleDateString('pt-BR')}</p>
                    <p className="text-sm text-gray-500">Próxima: {new Date(patient.nextAppointment).toLocaleDateString('pt-BR')}</p>
                  </div>
                </div>
                <div className="flex items-center space-x-2">
                  <span className={`px-2 py-1 text-xs rounded-full ${
